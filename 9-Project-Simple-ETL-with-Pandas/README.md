...
| Code  |               Title              	|
|:----:	|:--------------------------------:	|
| [📜](https://github.com/bayubagusbagaswara/dqlab-data-engineer/blob/master/9-Project-Simple-ETL-with-Pandas/Extract.py) | Extract |
...
| Code  |               Title              	|
|:----:	|:--------------------------------:	|
| [📜](https://github.com/bayubagusbagaswara/dqlab-data-engineer/blob/master/9-Project-Simple-ETL-with-Pandas/TransformKodePos.py) | Transform Kode Pos |
...
| Code  |               Title              	|
|:----:	|:--------------------------------:	|
| [📜](https://github.com/bayubagusbagaswara/dqlab-data-engineer/blob/master/9-Project-Simple-ETL-with-Pandas/TransformKota.py) | Transform Kota |
...
| Code  |               Title              	|
|:----:	|:--------------------------------:	|
| [📜](https://github.com/bayubagusbagaswara/dqlab-data-engineer/blob/master/9-Project-Simple-ETL-with-Pandas/TransformGithub.py) | Transform Github |
...
| Code  |               Title              	|
|:----:	|:--------------------------------:	|
| [📜](https://github.com/bayubagusbagaswara/dqlab-data-engineer/blob/master/9-Project-Simple-ETL-with-Pandas/TransformNomorHandphone.py) | Transform Nomor Handphone |
...
| Code  |               Title              	|
|:----:	|:--------------------------------:	|
| [📜](https://github.com/bayubagusbagaswara/dqlab-data-engineer/blob/master/9-Project-Simple-ETL-with-Pandas/TransformNamaTim.py) | Transform Nama Tim |
...
| Code  |               Title              	|
|:----:	|:--------------------------------:	|
| [📜](https://github.com/bayubagusbagaswara/dqlab-data-engineer/blob/master/9-Project-Simple-ETL-with-Pandas/TransformEmail.py) | Transform Email |
...
| Code  |               Title              	|
|:----:	|:--------------------------------:	|
| [📜](https://github.com/bayubagusbagaswara/dqlab-data-engineer/blob/master/9-Project-Simple-ETL-with-Pandas/TransformTanggalLahir.py) | Transform Tanggal Lahir |
...
| Code  |               Title              	|
|:----:	|:--------------------------------:	|
| [📜](https://github.com/bayubagusbagaswara/dqlab-data-engineer/blob/master/9-Project-Simple-ETL-with-Pandas/TransformTanggalDaftarKompetisi.py) | Transform Tanggal Daftar Kompetisi |
